...
const Contact = () => {
        ...
        try {
            ...
            if (error.text) {
                if (error.text.includes("Public Key")) {
                    errorMessage = "Invalid Public Key. Please check your EmailJS Public Key. Get it from https://dashboard.emailjs.com/admin/account";
    ...
    return (
        <div ref={sectionRef} className="w-full min-h-screen bg-white py-10 sm:py-16 md:py-20">
            <div ref={contentRef} className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                {/* Social Media Links */}
                <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-4 md:gap-6 lg:gap-8 mb-12 sm:mb-16">
                    <a
                        href={contactInfo.linkedin}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="group flex flex-col items-center gap-2 sm:gap-3 md:gap-4 p-4 sm:p-5 md:p-6 lg:p-8 bg-white/80 backdrop-blur-sm rounded-lg sm:rounded-xl md:rounded-2xl border-2 border-gray-200 hover:border-[#0077b5] hover:bg-white transition-all duration-300 hover:scale-105 hover:shadow-xl w-full sm:w-auto min-w-[140px] sm:min-w-0"
                    >
                        <div className="p-2.5 sm:p-3 md:p-4 bg-[#0077b5]/10 rounded-full group-hover:bg-[#0077b5]/20 transition-colors">
                            <svg
                                className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 text-[#0077b5] group-hover:scale-110 transition-transform"
                                fill="currentColor"
                                viewBox="0 0 24 24"
                            >
                        ...
                        <span className="text-gray-900 font-semibold font-[font2] text-sm sm:text-base md:text-lg">LinkedIn</span>
                    </a>
                    ...
                    <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="group flex flex-col items-center gap-2 sm:gap-3 md:gap-4 p-4 sm:p-5 md:p-6 lg:p-8 bg-white/80 backdrop-blur-sm rounded-lg sm:rounded-xl md:rounded-2xl border-2 border-gray-200 hover:border-gray-900 hover:bg-white transition-all duration-300 hover:scale-105 hover:shadow-xl w-full sm:w-auto min-w-[140px] sm:min-w-0"
                    >
                        <div className="p-2.5 sm:p-3 md:p-4 bg-gray-900/10 rounded-full group-hover:bg-gray-900/20 transition-colors">
                            <svg
                                className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 text-gray-900 group-hover:scale-110 transition-transform"
                                fill="currentColor"
                                viewBox="0 0 24 24"
                            >
                        ...
                        <span className="text-gray-900 font-semibold font-[font2] text-sm sm:text-base md:text-lg">GitHub</span>
                    </a>
                    ...
                    <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="group flex flex-col items-center gap-2 sm:gap-3 md:gap-4 p-4 sm:p-5 md:p-6 lg:p-8 bg-white/80 backdrop-blur-sm rounded-lg sm:rounded-xl md:rounded-2xl border-2 border-gray-200 hover:border-[#E4405F] hover:bg-white transition-all duration-300 hover:scale-105 hover:shadow-xl w-full sm:w-auto min-w-[140px] sm:min-w-0"
                    >
                        <div className="p-2.5 sm:p-3 md:p-4 bg-[#E4405F]/10 rounded-full group-hover:bg-[#E4405F]/20 transition-colors">
                            <svg
                                className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 text-[#E4405F] group-hover:scale-110 transition-transform"
                                fill="currentColor"
                                viewBox="0 0 24 24"
                            >
                        ...
                        <span className="text-gray-900 font-semibold font-[font2] text-sm sm:text-base md:text-lg">Instagram</span>
                    </a>
                </div>
